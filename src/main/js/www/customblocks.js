 ...
 * 터널 만들기
 */
Blockly.Blocks['drone_arc'] = {
  init: function() {
    this.appendValueInput("material")
        .setCheck(null)
        .appendField("원 그리기 재료");
    this.appendValueInput("radius")
        .setCheck(null)
        .appendField("지름");
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([["수직","vertical"], ["수평","horizontal"]]), "orientation")
        .appendField("채우기")
