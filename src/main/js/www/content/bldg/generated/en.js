...
planepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  switch (opt_ijData.level) {
    ...
    case 3:
      ...
      break;
    case 4:
      output += ' <img src="photo/house_front.jpg" height="200" width="200"><img src="photo/house_side.jpg" height="200" width="200"> ';
      break;
  }
  output += '</p><p> Make it like the picture above. <button id="deployButton" class="notext primary" title="..."><img src=\'../../google-blockly/media/1x1.gif\' class="run icon21"></button><button id="trashButton" class="notext" title="..."><img src=\'../../google-blockly/media/1x1.gif\' class="trash icon21"></button></p><script src="../../google-blockly/blockly_compressed.js"><\/script><script src="../../google-blockly/blocks_compressed.js"><\/script><script src="../../google-blockly/javascript_compressed.js"><\/script><script src="../../google-blockly/msg/js/' + soy.$$escapeHtml(opt_ijData.lang) + '.js"><\/script><script src="../../msg/js/' + soy.$$escapeHtml(opt_ijData.lang) + '.js"><\/script><script src="blocks.js"><\/script>' + planepage.toolbox(null, null, opt_ijData) + '<div id="blockly"></div>';
  return output;
};


planepage.toolbox = function(opt_data, opt_ignored, opt_ijData) {
  return '<xml id="toolbox" style="display: none"><block type="math_number"></block><block type="drone"></block><block type="rectangle"></block>' + ((opt_ijData.level > 1) ? '<block type="drone_move"></block>' + ((opt_ijData.level == 3) ? '<block type="controls_repeat_ext"></block>' + ((opt_ijData.level > 3) ? '<block type="prism"></block>' : '') : '') : '') + '</xml>';
};
